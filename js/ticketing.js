...
document.addEventListener('click', function(e) {
    ...
    // SAVE
        ...
        fetch('/ticketing-manager/airline-commissions/' + id, {
...
document.addEventListener('click', function(e) {
    ...
    // =========================
        ...
        row.cells[1].innerHTML = `<strong>${row.dataset.origin} → ${row.dataset.destination}</strong>`;
    ...
    // =========================
        ...
        fetch('/ticketing-manager/fare-commission-entries/' + id, {
